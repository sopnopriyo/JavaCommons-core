...
public class FileUtilBase_test {
	...
	public void byteCountToDisplaySizeFromBigInt_test() {
		String byteCount = FileUtilBase
			.byteCountToDisplaySize(new BigInteger(
				"8599825996872482982482982252524684268426846846846846849848418418414141841841984219848941984218942894298421984286289228927948728929829"));
