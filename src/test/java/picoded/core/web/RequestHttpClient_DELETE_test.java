...
public class RequestHttpClient_DELETE_test {
	...
	public void basic_delete_request_form() throws InterruptedException {
		...
		ResponseHttp responseHttp = requestHttpClient.httpDelete(mockWebServer.url("/").toString(),
			deleteBodyParams, null, null);
	...
	public void basic_delete_request_map_json() throws InterruptedException {
		...
		// Retrieve mockResponse from server and assert the results
		ResponseHttp responseHttp = requestHttpClient.httpDeleteJSON(mockWebServer.url("/")
			.toString(), deleteBodyParams, null, null);
		assertEquals(responseHttp.statusCode(), 200);
		assertEquals(responseHttp.toString(), "hello, world!");
	...
	public void cookies_delete_request_json() throws InterruptedException {
		...
		// Retrieve mockResponse from server and assert the results
		ResponseHttp responseHttp = requestHttpClient.httpDeleteJSON(mockWebServer.url("/")
			.toString(), params, cookiesMap, null);
		assertEquals(responseHttp.statusCode(), 200);
		assertEquals(responseHttp.toString(), "hello, world!");
	...
	public void basic_delete_request_multipart_params_only() throws InterruptedException {
		...
		// Retrieve mockResponse from server and assert the results
		ResponseHttp responseHttp = requestHttpClient.httpDeleteMultipart(mockWebServer.url("/")
	 ...
	 */
	@Test
	public void basic_delete_request_multipart_params_and_files() throws IOException,
	...
	public void basic_delete_request_form_wrapper() throws InterruptedException {
		...
		// Retrieve mockResponse from server and assert the results
		ResponseHttp responseHttp = requestHttpClient.delete(mockWebServer.url("/").toString(),
			deleteBodyParams, null, null);
		assertEquals(responseHttp.statusCode(), 200);
		assertEquals(responseHttp.toString(), "hello, world!");
	...
	public void headers_delete_request_form_wrapper() throws InterruptedException {
		...
		// Retrieve mockResponse from server and assert the results
		ResponseHttp responseHttp = requestHttpClient.delete(mockWebServer.url("/").toString(), null,
			null, headers);
		assertEquals(responseHttp.statusCode(), 200);
		assertEquals(responseHttp.toString(), "hello, world!");
	...
	public void basic_delete_request_multipart_params_only_wrapper() throws InterruptedException {
		...
		// Retrieve mockResponse from server and assert the results
		ResponseHttp responseHttp = requestHttpClient.deleteMultipart(mockWebServer.url("/")
			.toString(), deleteBodyParams, null, null, null);
		assertEquals(responseHttp.statusCode(), 200);
		assertEquals(responseHttp.toString(), "hello, world!");
	 ...
	 */
	@Test
	public void basic_delete_request_multipart_files_only_wrapper() throws IOException,
		InterruptedException {
		mockWebServer.enqueue(new MockResponse().setBody("hello, world!"));
	 ...
	 */
	@Test
	public void basic_delete_request_multipart_params_and_files_wrapper() throws IOException,
		InterruptedException {
		mockWebServer.enqueue(new MockResponse().setBody("hello, world!"));
		...
		// Retrieve mockResponse from server and assert the results
		ResponseHttp responseHttp = requestHttpClient.deleteMultipart(mockWebServer.url("/")
			.toString(), deleteBodyParams, filesMap, null, null);
		assertEquals(responseHttp.statusCode(), 200);
		assertEquals(responseHttp.toString(), "hello, world!");
