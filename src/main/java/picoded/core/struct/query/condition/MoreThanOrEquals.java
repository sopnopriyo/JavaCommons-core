...
public class MoreThanOrEquals extends ConditionBase {
	 ...
	 **/
	public MoreThanOrEquals(String field, String argName, Map<String, Object> defaultArgMap) {
	...
	public QueryType type() {
		return QueryType.MORE_THAN_OR_EQUALS;
	}
